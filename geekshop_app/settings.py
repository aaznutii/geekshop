"""
Django settings for geekshop_app project.
...
SECRET_KEY = 'django-insecure-9+ud3!s505)rep=$^vddad@3r*2o_bh)^ju*41at7*%b!u(&hx'
...
ROOT_URLCONF = 'geekshop_app.urls'
...
WSGI_APPLICATION = 'geekshop_app.wsgi.application'
